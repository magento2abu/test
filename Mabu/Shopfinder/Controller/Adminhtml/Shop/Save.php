...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            $rowData = $this->_objectManager->create('Mabu\Shopfinder\Model\Shop');
            if (isset($data['image']['value'])) {
                $oldImage = $data['image']['value'];
                unset($data['image']);
                $data['image'] = $oldImage;
            } else {
                $data['image'] = 'mabu/shopfinder/images/e/m/empty.jpg';
            }
            ...
            if (
                ...
                try {
                    $baseMediaPath = 'mabu/shopfinder/images';
    ...
    {
        return $this->_authorization->isAllowed('Mabu_Auction::add_auction');
    }
}
